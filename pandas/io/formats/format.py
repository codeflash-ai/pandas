...
def get_format_datetime64(
    ...
    if is_dates_only:
        ...
        def _formatter(x, _nat_rep=nat_rep, _date_format=date_format):
            return _format_datetime64_dateonly(
                x, nat_rep=_nat_rep, date_format=_date_format
            )

        return _formatter
    else:

        def _formatter(x, _nat_rep=nat_rep):
            return _format_datetime64(x, nat_rep=_nat_rep)
